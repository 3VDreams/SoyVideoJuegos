...
public class VideoListFetchTask extends AsyncTask<String, Void, String> {

    private final VideoListListener listener;
    private String msg;

    public VideoListFetchTask(VideoListListener listener) {
    ...
    protected void onPostExecute(String stream) {
        ...
        try {
            ...
            VideoListJSON json = new VideoListJSON();
            List<VideoList> apps = json.get(stream);
